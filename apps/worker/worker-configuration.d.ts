/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false apps/worker/worker-configuration.d.ts` (hash: f6f7bf0d255548bf325e4a3f16aab95e)
...
interface __BaseEnv_Env {
	...
	OPENAI_VOICE_THRESHOLD: string;
	OPENAI_VOICE_SILENCE_MS: string;
	OPENAI_VOICE_NOISE_REDUCTION: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "OPENAI_TEXT_MODEL" | "OPENAI_VOICE_MODEL" | "OPENAI_VOICE_THRESHOLD" | "OPENAI_VOICE_SILENCE_MS" | "OPENAI_VOICE_NOISE_REDUCTION">> {}
}
